...
function createMidRidgeOrnament(
  ...
  const base = new Mesh(new BoxGeometry(0.68, 0.16, 0.42), materials.yellowGlaze);
  base.userData.kind = 'mid-ridge-ornament-base';
  const body = new Mesh(new SphereGeometry(0.24, 10, 8), materials.yellowGlaze);
  body.scale.set(1.05, 1.28, 0.78);
  body.position.y = 0.28;
  const head = new Mesh(new SphereGeometry(0.18, 10, 8), materials.yellowGlaze);
  head.scale.set(1.25, 0.92, 0.85);
  head.position.set(0.25, 0.52, 0);
  const crest = new Mesh(new ConeGeometry(0.1, 0.4, 8), materials.yellowGlaze);
  crest.rotation.z = -0.55;
  crest.position.set(0.1, 0.68, 0);
  const eye = new Mesh(new SphereGeometry(0.05, 8, 6), materials.yellowGlaze);
...
function createRidgeEndBeast(
  ...
  const base = new Mesh(new BoxGeometry(0.58, 0.15, 0.38), materials.yellowGlaze);
  base.userData.kind = 'ridge-end-beast-base';
  const body = new Mesh(new SphereGeometry(0.23, 10, 8), materials.yellowGlaze);
  body.scale.set(1.25, 1.05, 0.78);
  body.position.set(0, 0.3, 0);
  const head = new Mesh(new SphereGeometry(0.17, 10, 8), materials.yellowGlaze);
  ...
  const crest = new Mesh(new ConeGeometry(0.09, 0.34, 8), materials.yellowGlaze);
  crest.rotation.z = -0.48;
  crest.position.set(0.14, 0.68, 0);
  const tail = new Mesh(new ConeGeometry(0.1, 0.42, 8), materials.yellowGlaze);
  tail.rotation.z = 0.8;
